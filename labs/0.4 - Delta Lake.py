...
# MAGIC     INSERT (tpep_pickup_datetime, tpep_dropoff_datetime, trip_distance, fare_amount, pickup_zip, dropoff_zip)
# MAGIC     VALUES (source.tpep_pickup_datetime, source.tpep_dropoff_datetime, source.trip_distance, source.fare_amount, source.pickup_zip, source.dropoff_zip)
...
silver_stream_df = (spark.readStream
    ...
    .agg(
        ...
        sum(col("fare_amount")).alias("total_revenue"),  # Column to sum
        avg(col("trip_distance")).alias("avg_trip_distance")  # Column to average
    )
)
