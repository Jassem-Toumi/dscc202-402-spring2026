...
from pyspark.sql.functions import lit, concat, when, upper, lower, col, expr, explode

# Load base customers
base_customers_df = spark.table("samples.bakehouse.sales_customers")

print(f"Base customers Count: {base_customers_df.count()}")
...
# clean_customers_df.printSchema()
# usa_franchises_df.printSchema()
